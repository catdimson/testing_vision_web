...
class LandingData(models.Model):
    # шапка
    logo = models.ImageField(verbose_name="Логотип", upload_to="static/img/uploads/header")
    ...
    img_block1 = models.ImageField(verbose_name="Картинка", upload_to="static/img/uploads/block1")
    ...
    text2_block2 = models.TextField(verbose_name="Текст 2",
                                    default="Задача курса \"Простые финансы\" – не просто рассказать про деньги, "
                                            ...
                                            "зарабатывать.")
    img_block2 = models.ImageField(verbose_name="Картинка", upload_to="static/img/uploads/block2")
    ...
    img_col1 = models.ImageField(verbose_name="Картинка (колонка 1)", upload_to="static/img/uploads/block3")
    ...
    img_col2 = models.ImageField(verbose_name="Картинка (колонка 2)", upload_to="static/img/uploads/block3")
    ...
    img_col3 = models.ImageField(verbose_name="Картинка (колонка 3)", upload_to="static/img/uploads/block3")
    ...
    img_col4 = models.ImageField(verbose_name="Картинка (колонка 4)", upload_to="static/img/uploads/block3")
    ...
    img_block4 = models.ImageField(verbose_name="Картинка", upload_to="static/img/uploads/block4")
    ...
    # блок 7
    h2_block7 = models.CharField(max_length=150, verbose_name="Заголовок h2", default="Пройдите бесплатный урок")
    text_block7 = models.TextField(max_length=150, verbose_name="",
                                   default="Чтобы мотивировать детей продолжать обучение, мы выстроили курс с учётом"
                                           "психологии подростков. А чего они хотят больше всего?")
